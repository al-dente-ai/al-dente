...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        'bg-neutral-100 hover:bg-neutral-200 text-neutral-800 focus:ring-neutral-300 border border-neutral-200',
      outline:
        'border border-neutral-300 bg-white hover:bg-neutral-50 text-neutral-800 focus:ring-primary-400',
